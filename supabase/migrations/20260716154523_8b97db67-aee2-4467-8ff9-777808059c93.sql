...
grant select, insert, update, delete on public.prediction_groups to authenticated;
grant all on public.prediction_groups to service_role;
...
grant all on public.group_leaderboard to service_role;
